...
//        ShaderRegistry.loadShader("res/shader/dropShadow.vert", "res/shader/dropShadow.frag", "dropShadow", Array((0, "in_Position"), (1, "in_TextureCoord"), (2, "in_zIndex")))
        ...
        ShaderRegistry.loadShader("res/shader/font.vert", "res/shader/font.frag", "font", Array((0, "in_Position"), (1, "in_TextureCoord"), (2, "in_Color")))
    ...
    def registerEventListeners(): Unit = {
        ...
        EventRegistry.registerButtonEventListener(new EventListenerGuiButton)
