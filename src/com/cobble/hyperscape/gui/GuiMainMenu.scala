...
//    val woah = new GuiButton("WOAH A NEW BUTTON!", -330f, 0f, 300f, 300f, new Vector3f(0.141f, 0.317f, 0.709f))
    ...
    elementList = elementList :+ new GuiButton("Options", -330f, -115f, 660f, 75f, new Vector3f(1f, 0f, 0f))
    elementList = elementList :+ new GuiButton("Exit Game", -330f, -300, 660f, 75f, new Vector3f(1f, 0f, 0f))
